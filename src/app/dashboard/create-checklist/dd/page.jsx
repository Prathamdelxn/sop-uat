...
const [recordCount, setRecordCount] = useState(1);
 ...
 const addNewRows = (count) => {
            ...
            <div className="flex items-start flex-col gap-3">
              ...
              <div className={`space-y-1 ${hasError ? "border-l-4 border-red-500 bg-red-50 p-3 rounded-lg" : ""}`}>
                ...
                <input
                  ...
                  onChange={(e) => handleCheckPointChange(item.id, e.target.value)}
                  onBlur={() => {
                    if (!item.checkpoint?.title?.trim()) {
                      setTableErrors((prev) => ({ ...prev, [item.id]: "Check Point title is required" }));
                    }
                  }}
  ...
  //     return;
  //   }
  //   // NEW VALIDATION: Ensure at least one checkpoint in visual representation table
